...
> <img width="800" src="./Resources/db_server_flask.png">
> Below are an example of the data that can be obtained from using the FLASK API
> <img width="800" src="./Resources/flask_api_call_black_table.png">
> <img width="800" src="./Resources/flask_api_call_white_table.png">
> <img width="800" src="./Resources/flask_db_api_aggregate.png">
...
##### **New Library**
> We challenged ourselves in using a new library, Seaborn, to create a graph for out presentation
